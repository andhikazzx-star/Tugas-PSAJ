...
<div class="dashboard-grid">
    ...
    <?php if (in_array(ROLE_PEMBINA_EKSKUL, $roles)): ?>
        <!-- ===== PEMBINA EKSKUL ===== -->
        <section class="section-full">
            <div class="section-header">
                        ...
                        <tbody>
                            <?php foreach ($ekskul_list as $e): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="?page=ekskul.input&ekskul_id=<?= $e['id'] ?>&semester=1"
                                            class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i> Input Nilai (Ganjil)
                                        </a>
                                        <a href="?page=ekskul.input&ekskul_id=<?= $e['id'] ?>&semester=2"
                                            class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i> Input Nilai (Genap)
                                        </a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
            ...
            <?php else: ?>
                <div class="empty-state">
                    <i class="fas fa-inbox"></i>
                    <p>Belum ada ekstrakurikuler yang ditugaskan kepada Anda.</p>
                </div>
            <?php endif; ?>
        </section>
    <?php endif; ?>
