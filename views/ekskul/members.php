...
<div class="dashboard-grid">
    <section class="section-full">
        <div class="section-header">
            ...
            <a href="?page=ekskul.anggota" class="btn btn-secondary">
                                    ...
                                    <?php foreach ($members as $m): ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <a href="?page=ekskul.remove_member&ekskul_id=<?= $ekskul['id'] ?>&siswa_id=<?= $m['siswa_id'] ?>&semester=<?= $semester ?>" 
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body" style="padding: 15px;">
                        <form action="" method="GET" class="search-form" style="display: flex; gap: 10px; margin-bottom: 20px;">
                            <input type="hidden" name="page" value="ekskul.members">
                                    ...
                                    <tbody>
                                        <?php foreach ($available_siswa as $s): ?>
                                            <tr>
                                                ...
                                                <td style="text-align:center;">
                                                    <a href="?page=ekskul.add_member&ekskul_id=<?= $ekskul['id'] ?>&siswa_id=<?= $s['id'] ?>&semester=<?= $semester ?>" 
