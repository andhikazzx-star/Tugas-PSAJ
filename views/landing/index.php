                ...
                <div class="hero-stats-card">
                    <div class="hero-stat-item">
                        ...
                        <div class="hero-stat-info">
                            <div class="hero-stat-num" id="count-siswa">0</div>
                    ...
                    <div class="hero-stat-item">
                        ...
                        <div class="hero-stat-info">
                            <div class="hero-stat-num" id="count-guru">0</div>
                            <div class="hero-stat-label">Guru Pengampu</div>
                        </div>
                    </div>
                    <div class="hero-stat-item">
                        <div class="hero-stat-icon"><i class="fas fa-door-open"></i></div>
                        <div class="hero-stat-info">
                            <div class="hero-stat-num" id="count-kelas">0</div>
                            <div class="hero-stat-label">Total Kelas</div>
                        </div>
                    </div>
                    <div class="hero-stat-item">
                        <div class="hero-stat-icon"><i class="fas fa-calendar-alt"></i></div>
                        <div class="hero-stat-info">
                            <div class="hero-stat-num" id="current-tahun-ajaran">-</div>
                            <div class="hero-stat-label">Tahun Ajaran</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="roles-grid">
                ...
                <div class="role-card fade-in-up delay-4">
                    ...
                    <div class="role-name">Ketua Program Keahlian</div>
